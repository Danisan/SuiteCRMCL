...
--
-- Servidor: localhost
-- Tiempo de generación: 10-12-2013 a las 07:57:28
-- Versión del servidor: 5.1.67
-- Versión de PHP: 5.3.2-1ubuntu4.21
...
--
-- Estructura de tabla para la tabla `dha_plantillasdocumentos`
--
...
--
-- Estructura de tabla para la tabla `dha_plantillasdocumentos_audit`
--
...
--
-- Estructura de tabla para la tabla `import_emails`
--
...
--
-- Estructura de tabla para la tabla `import_emails_in_process`
--

CREATE TABLE IF NOT EXISTS `import_emails_in_process` (
  `id` varchar(36) NOT NULL,
  `import_email_id` varchar(36) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `kreports` (
  ...
  `deleted` tinyint(1) DEFAULT '0',
  `assigned_user_id` char(36) DEFAULT NULL,
  `report_module` varchar(25) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `kreportschedules`
--

CREATE TABLE IF NOT EXISTS `kreportschedules` (
  `id` char(36) NOT NULL,
  `date_entered` datetime DEFAULT NULL,
  ...
  `minutes` varchar(2) DEFAULT NULL,
  `action` varchar(2) DEFAULT NULL,
  `receipients` text,
  `deleted` tinyint(1) DEFAULT NULL,
  `ext_desc` text,
  `int_desc` text,
  `selvar` varchar(36) DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `kreportscheduleslog`
--

CREATE TABLE IF NOT EXISTS `kreportscheduleslog` (
  `id` char(36) NOT NULL,
...
--
-- Estructura de tabla para la tabla `kreportsfavorites`
--

CREATE TABLE IF NOT EXISTS `kreportsfavorites` (
  `id` char(36) NOT NULL,
  `user_id` char(36) DEFAULT NULL,
  `report_id` char(36) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `kreportsnapshots`
--
...
--
-- Estructura de tabla para la tabla `kreportsnapshotsdata`
--

CREATE TABLE IF NOT EXISTS `kreportsnapshotsdata` (
  `snapshot_id` char(36) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla `kreportstats`
--

CREATE TABLE IF NOT EXISTS `kreportstats` (
  `id` char(36) NOT NULL,
  `user_id` char(36) DEFAULT NULL,
  `report_id` char(36) DEFAULT NULL,
